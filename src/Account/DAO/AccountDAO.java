...
public class AccountDAO {
    ...
    public List<AccountVO> selectAccountDAO(UserVO userVO, String nicknameOrBank) {
    ...
    public List<AccountVO> selectAccountByBankDAO(UserVO userVO, String tempBank) {
    ...
    public void deleteAccountDAO(UserVO userVO, int accountNumber) {
    ...
    public void reviseAccountDAO(UserVO userVO, String newNickname, int tempAccountNumber) {
    ...
    // 별칭 혹은 계좌번호로 입금
    public void depositDAO(UserVO userVO, long originalBalance, long depositAmount, int tempAccountNumber) {
    ...
    // 별칭 혹은 계좌번호로 출금
    public void withdrawDAO(UserVO userVO, long originalBalance, long withdrawAmount, int tempAccountNumber) {
